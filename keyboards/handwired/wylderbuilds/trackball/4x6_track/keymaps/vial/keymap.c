...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_4x6(
        ...
        KC_LSFT, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  , KC_MUTE,     KC_N  , KC_M  , KC_COMM,KC_DOT ,KC_SLSH, KC_BSLS,
        KC_LCTL, KC_LALT, KC_LGUI, KC_LBRC,                                           KC_RBRC,KC_RGUI,KC_RALT, KC_RCTL,
                                     RAISE, KC_SPC, KC_BSPC,             LOWER,
                                     KC_TAB, KC_LALT, KC_LCTL,           KC_ENT,
                                                                    KC_RALT
        ),

    [_LOWER] = LAYOUT_4x6(
        _______,KC_1,   KC_2,   KC_3,   KC_4,   KC_5,                        KC_6,    KC_7,   KC_8,   KC_9,  KC_0,   _______,
        _______,_______,_______,_______,_______,KC_LBRC,                     KC_RBRC, KC_P7 , KC_P8 , KC_P9 ,KC_PLUS,QK_BOOT,
        _______,KC_HOME,KC_PGUP,KC_PGDN,KC_END ,KC_LPRN, KC_HOME,            KC_RPRN, KC_P4 , KC_P5 , KC_P6 ,KC_MINS,KC_PIPE,
        WYLD_AUTO_MS_TOG,DPI_RMOD,DPI_MOD,DPI_RST,                                            KC_P2 , KC_P3 ,KC_EQL ,KC_UNDS,
                                        _______,  KC_BTN3,KC_BTN1,             _______,
    ...
    [_RAISE] = LAYOUT_4x6(
        ...
        KC_LEFT, KC_UP ,KC_DOWN,KC_RGHT,                                                     KC_MPLY,KC_MNXT,KC_VOLD,KC_VOLU,
